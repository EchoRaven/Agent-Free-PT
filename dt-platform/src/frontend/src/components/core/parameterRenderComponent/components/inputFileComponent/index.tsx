                      ...
                      <Button
                        ...
                        className={cn(
                          selectedFiles.length !== 0
                            ...
                            : "w-full",
                          "font-semibold",
                          // Apply purple styling for attack fields with dark text
                          metadata?.attack === true && "border-purple-500 focus:border-purple-600 focus:ring-purple-500 bg-purple-100 dark:bg-purple-950/30 hover:bg-purple-200 dark:hover:bg-purple-950/40 text-purple-900 dark:text-purple-100",
                        )}
              ...
              <div>
                <Button
                  className={cn(
                    ...
                    editNode && "h-6",
                    // Apply purple styling for attack fields with dark text
                    metadata?.attack === true && "border-purple-500 focus:border-purple-600 focus:ring-purple-500 bg-purple-200 dark:bg-purple-950/40 hover:bg-purple-300 dark:hover:bg-purple-950/50 text-purple-900 dark:text-purple-100",
                  )}
                  onClick={handleButtonClick}
                  disabled={isDisabled}
                  size="icon"
