...
import DecodingTrustLogo from "@/icons/DecodingTrust";
...
export default function AppHeader(): JSX.Element {
  ...
  return (
    <div
      className={`z-10 flex h-[64px] w-full items-center justify-between border-b px-6 dark:bg-background shadow-sm`}
        ...
        <div className="flex items-center gap-2">
          ...
          >
            {ENABLE_DATASTAX_LANGFLOW ? (
              ...
              <DecodingTrustLogo className="h-9 w-9 fill-black dark:fill-white" />
            )}
          </Button>
          {!ENABLE_DATASTAX_LANGFLOW && (
