...
export default function Dropdown({
  ...
  metadata,
  ...baseInputProps
}: BaseInputProps & DropDownComponent & { metadata?: any }): JSX.Element {
  ...
  const renderTriggerButton = () => {
    const isAttackField = metadata?.attack === true;
    return (
      <div className="flex w-full flex-col">
        <PopoverTrigger asChild>
          ...
          className={cn(
            ...
            // Apply purple styling for attack fields
            isAttackField && "border-purple-500 focus:border-purple-600 focus:ring-purple-500 bg-purple-100 dark:bg-purple-950/30",
          )}
        >
          <span
