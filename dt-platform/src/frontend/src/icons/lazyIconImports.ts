...
export const lazyIconsMapping = {
  ...
  BracesAlert: () =>
    import("@/icons/BracesAlert").then((mod) => ({ default: mod.default })),
  FileTextAlert: () =>
    import("@/icons/FileTextAlert").then((mod) => ({ default: mod.default })),
  AgentQL: () =>
  ...
  MCPInjection: () =>
    import("@/icons/MCPInjection").then((mod) => ({ default: mod.default })),
  ...
  SQLInjection: () =>
    import("@/icons/SQLInjection").then((mod) => ({ default: mod.default })),
  Streamlit: () =>
  ...
  WebInjection: () =>
    import("@/icons/WebInjection").then((mod) => ({ default: mod.default })),
  Wikipedia: () =>
  ...
  DecodingTrust: () =>
    import("@/icons/DecodingTrust").then((mod) => ({ default: mod.default })),
  VirtueAgent: () =>
    import("@/icons/VirtueAI").then((mod) => ({ default: mod.default })),
  Zelle: () =>
    import("@/icons/Zelle").then((mod) => ({ default: mod.Zelle })),
};
