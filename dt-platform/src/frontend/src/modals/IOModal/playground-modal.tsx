              ...
              >
                ...
                {sidebarOpen && showPublishOptions && (
                  <div className="absolute bottom-2 left-0 flex w-full flex-col gap-8 border-t border-border px-2 py-4 transition-all">
                    ...
                    >
                      <VirtueAILogo className="h-5 w-5 fill-white" />
                      <div className="text-sm">Built with DecodingTrust-Agent</div>
                    </Button>
                  </div>
                )}
              </div>
            ...
            {!sidebarOpen && showPublishOptions && (
              <div className="absolute bottom-6 left-4 hidden transition-all md:block">
                <ShadTooltip
                  styleClasses="z-50"
                  side="right"
                  content="Built with DecodingTrust-Agent"
                >
                  <Button
                    variant="primary"
                    ...
                    onClick={LangflowButtonClick}
                  >
                    <VirtueAILogo className="h-[18px] w-[18px] scale-150 fill-white" />
                  </Button>
                </ShadTooltip>
              </div>
            )}
