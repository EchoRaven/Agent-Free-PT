...
const EMPTY_PAGE_TITLE = "Welcome to DecodingTrust-Agent Platform";
const EMPTY_PAGE_DESCRIPTION = "Your new favorite way to ship Agents";
const EMPTY_PAGE_PLATFORM_DOCS_DESCRIPTION =
  "Access comprehensive documentation for the DecodingTrust-Agent Platform.";
const EMPTY_PAGE_DEV_GUIDE_DESCRIPTION =
  "Learn how to set up and develop with the platform.";
          ...
          <div className="z-50 flex h-full w-full flex-col items-center justify-center gap-5">
            <div className="z-50 flex flex-col items-center gap-2">
              <div className="z-50">
                <img
                  ...
                  className="relative top-3 h-16 w-auto"
                />
              </div>
              <span
            ...
            <div className="flex w-full max-w-[510px] flex-col gap-7 sm:gap-[29px]">
              <Button
                ...
                onClick={() => {
                  handleUserTrack("platform_docs_clicked")();
                  window.open("https://docs.google.com/document/d/16SkMOpf7FNickiiC56oIfgiXrs8yeSa6BSFjvmpx2n4/edit?tab=t.v7ho89k97dm3", "_blank", "noopener,noreferrer");
                }}
                data-testid="empty_page_platform_docs_button"
              >
                <div className="relative flex flex-col rounded-lg border-[1px] bg-background p-4 transition-all duration-300 hover:border-accent-pink-foreground">
                  <div className="grid w-full items-center justify-between gap-2">
                    <div className="flex gap-3">
                      ...
                      />
                      <div>
                        <span className="font-semibold">Platform Documentation</span>
                      </div>
                    </div>
                    <div>
                      <span className="text-base text-secondary-foreground">
                        {EMPTY_PAGE_PLATFORM_DOCS_DESCRIPTION}
                      </span>
                    </div>
                  </div>
              ...
              <Button
                ...
                className="group mx-3 h-[84px] sm:mx-0"
                onClick={() => {
                  handleUserTrack("dev_guide_clicked")();
                  window.open("https://docs.google.com/document/d/16SkMOpf7FNickiiC56oIfgiXrs8yeSa6BSFjvmpx2n4/edit?tab=t.73c90d5hp7f9", "_blank", "noopener,noreferrer");
                }}
                data-testid="empty_page_dev_guide_button"
              >
                <div className="relative flex flex-col rounded-lg border-[1px] bg-background p-4 transition-all duration-300 hover:border-foreground">
                  <div className="grid w-full items-center justify-between gap-2">
                    <div className="flex gap-3">
                      <ForwardedIconComponent
                        strokeWidth={2}
                      ...
                      />
                      <div>
                        <span className="font-semibold">Development Guide</span>
                      </div>
                    </div>
                    <div>
                      <span className="text-base text-secondary-foreground">
                        {EMPTY_PAGE_DEV_GUIDE_DESCRIPTION}
                      </span>
                    </div>
                  </div>
                  <ExternalLink className={EXTERNAL_LINK_ICON_CLASS} />
